...
python3 train_test.py -f mfcc -c 10 18 26 34 40 -s 3 -a 3 -n 0.75 -t True -m knn
python3 train_test.py -f mfcc -c 10 18 26 34 40 -s 2 -a 3 -n 0.75 -t True -m knn
python3 train_test.py -f mfcc -c 10 18 26 34 40 -s 1 -a 3 -n 0.75 -t True -m knn
python3 train_test.py -f lpc -c 256 512 1024 2048 -s 3 -a 3 -n 0.75 -t True -m knn
python3 train_test.py -f lpc -c 256 512 1024 2048 -s 2 -a 3 -n 0.75 -t True -m knn
python3 train_test.py -f lpc -c 256 512 1024 2048 -s 1 -a 3 -n 0.75 -t True -m knn
python3 train_test.py -f stft -c 256 512 1024 2048 -s 3 -a 3 -n 0.75 -t True -m knn
python3 train_test.py -f stft -c 256 512 1024 2048 -s 2 -a 3 -n 0.75 -t True -m knn
python3 train_test.py -f stft -c 256 512 1024 2048 -s 1 -a 3 -n 0.75 -t True -m knn
python3 train_test.py -f fft -c 256 512 1024 2048 -s 3 -a 3 -n 0.75 -t True -m knn
python3 train_test.py -f fft -c 256 512 1024 2048 -s 2 -a 3 -n 0.75 -t True -m knn
python3 train_test.py -f fft -c 256 512 1024 2048 -s 1 -a 3 -n 0.75 -t True -m knn